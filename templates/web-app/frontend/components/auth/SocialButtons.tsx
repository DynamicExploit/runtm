...
export function SocialButtons({ onSuccess }: SocialButtonsProps) {
  ...
  // In production, these env vars would be set
    ...
    <div className="space-y-3 w-full max-w-sm">
      {hasGoogle && (
        <button
          ...
          className="w-full p-3 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
        >
          <GoogleIcon />
