...
description: "Human-in-the-loop for AI-proposed changes"
---

Runtm supports a workflow where AI agents propose infrastructure changes and humans approve them before deployment.
